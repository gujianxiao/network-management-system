...
<script src="functionjs.js"type="text/javascript">
</script>
  ...
  <div class="container-fluid">
        <div class="row">
          <div class="col-md-2">
                <ul id="main-nav" class="main-nav nav nav-tabs nav-stacked" style="">
                    ...
                    <li>
                        ...
                        <ul id="systemSetting" class="nav nav-list secondmenu collapse" style="height: 0px;">
                            ...
                            <li><a href="#" onclick="javascript:showsend();"><i class="glyphicon glyphicon-send"></i>&nbsp;SendInts</a></li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="col-md-10">
                <iframe id="showwindow" src="newmap.jsp"> </iframe>
            </div>
        </div>
    </div>
</div>
